...
#done and locked using rails db:migrate
...
new_role = Role.new
new_role["movie_id"] = dark_night["id"]
new_role["actor_id"] = bale["id"]
new_role["character_name"] = "Bruce Wayne"
new_role.save
...
new_role = Role.new
new_role["movie_id"] = dark_night_rises["id"]
new_role["actor_id"] = bale["id"]
new_role["character_name"] = "Bruce Wayne"
new_role.save
...
for cast_member in cast
    movie = Movie.find_by("id" => cast_member["movie_id"])
    actor = Actor.find_by("id" => cast_member["actor_id"])
    puts "#{movie.title}\t#{actor.name}\t#{cast_member.character_name}"
end